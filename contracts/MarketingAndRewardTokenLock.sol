 ...
 */
contract MarketingAndRewardTokenLockTokenLock {
    using SafeERC20 for IERC20;

    string public name = "MarketingAndRewardTokenLock Round Token Lock";

    uint256 totalSupply = 1_000_000_000;
    uint256 percentShare = 4000;

    uint256 public percentTge = 4;
    uint256 public monthsCliff = 0;
    // total Month release token After TGE
    uint256 public months = uint256(24);
